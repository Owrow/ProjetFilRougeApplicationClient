  ...
  <h3>Réservation de Restaurant</h3>
    ...
    <form action="ServletTraitementReservation" method="post">
        ...
        <select id="creneau" name="creneau" required>
          <optgroup>Service du midi</optgroup>
            <option value="12:00">12:00</option>
            <option value="12:30">12:30</option>
            <option value="13:00">13:00</option>
            <option value="13:30">13:30</option>
          <optgroup>Service du soir</optgroup>
        ...
        <label for="tailleGroupe">Taille du groupe :</label>
        <input type="number" id="tailleGroupe" name="tailleGroupe" min="1" required>
