        ...
        <div class="row row-cols-1 row-cols-md-2">
            ...
            <c:forEach var="current" items="${restaurants}">
                <div class="col mb-4">
                    ...
                    <div class="card">
                        <img class="card-img-top" src="<c:url value='/assets/${current.id}.jpeg' />" alt="Image" />
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">de ${current.ouverture} à ${current.fermeture}</li>
                            </ul>
                            <form action="ServletTraitementReservation" method="GET">
                                ...
                                <c:if test="${sessionScope.client.nom ne null}">
                                    <input class="btn btnDetails" type="submit" value="Plus d'informations / Réserver" />
                                </c:if>
